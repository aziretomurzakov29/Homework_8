...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Witcher witcher= new Witcher(500,0,"Natasha");
        Deku deku= new Deku(350,20,"Asta");
        Golem golem = new Golem(600,3,"Golem");

        Hero[] heroes = {warrior, doc, magic, berserk,
                assistant, witcher,deku, golem};
